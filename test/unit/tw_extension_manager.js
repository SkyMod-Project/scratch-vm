...
test('_isValidExtensionURL', t => {
    ...
    t.equal(manager._isValidExtensionURL('skymod-project.github.io/extensions/fetch.js'), false);
    t.equal(manager._isValidExtensionURL('https://skymod-project.github.io/extensions/fetch.js'), true);
    t.equal(manager._isValidExtensionURL('http://skymod-project.github.io/extensions/fetch.js'), true);
