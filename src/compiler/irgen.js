...
class ScriptTreeGenerator {
    ...
    descendInput (block) {
        ...
        case 'argument_reporter_boolean': {
            ...
            const index = this.script.arguments.lastIndexOf(name);
            if (index === -1) {
                if (name.toLowerCase() === 'is compiled?' || name.toLowerCase() === 'is skymod?') {
                    return {
                        kind: 'constant',
                        value: true
                    };
    ...
    descendStackedBlock (block) {
        ...
        case 'motion_movebacksteps':
            return {
                ...
                steps: {
                    ...
                    right: this.descendInputOfBlock(block, 'STEPS')
                }
            };
        ...
        case 'motion_pointinrandomdirection':
            return {
                kind: 'motion.pointInRandomDirection'
            };
        ...
        case 'motion_turnleftaroundxy':
            return {
                kind: 'motion.leftAroundXY',
                degrees: this.descendInputOfBlock(block, 'DEGREES'),
                x: this.descendInputOfBlock(block, 'X'),
                y: this.descendInputOfBlock(block, 'Y')
            };
