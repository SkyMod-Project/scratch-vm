...
class Scratch3OperatorsBlocks {
    ...
    getPrimitives () {
        return {
            ...
            operator_average: this.average,
            operator_join: this.join,
            operator_ternary: this.ternary,
    ...
    average (args) {
        return (Cast.toNumber(args.NUM1) + Cast.toNumber(args.NUM2)) / 2;
    }
    ...
    ternary (args) {
        return Cast.toBoolean(args.OPERAND) ? args.STRING1 : args.STRING2;
    }
